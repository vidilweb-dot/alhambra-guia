...
// motivos reales de la arquitectura nazarí y renacentista (arcos, agua,
// celosías, epigrafía, geometría clásica), no son reproducciones de
// fotografías ni de obras existentes.
...
const STOP_ICONS = {
  ...
  4: `<svg viewBox="0 0 100 100"><circle class="ic-bg" cx="50" cy="50" r="46"/>
    <rect class="ic-line" x="26" y="26" width="48" height="48" fill="none" stroke-width="3"/>
    <circle class="ic-gold" cx="50" cy="50" r="17" fill="none" stroke-width="3"/></svg>`,
  ...
  13: `<svg viewBox="0 0 100 100"><circle class="ic-bg" cx="50" cy="50" r="46"/>
