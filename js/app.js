...
const els = {
  ...
  illustration: document.getElementById('stopIllustration'),
  mapToggle: document.getElementById('mapToggle'),
  mapImagePanel: document.getElementById('mapImagePanel'),
  mapImageClose: document.getElementById('mapImageClose'),
};
...
function loadStop(i, autoplay = false) {
  ...
  els.illustration.innerHTML = (window.STOP_ICONS && STOP_ICONS[current]) || '';
...
els.mapToggle.addEventListener('click', () => {
  els.mapImagePanel.classList.add('open');
});
els.mapImageClose.addEventListener('click', () => {
  els.mapImagePanel.classList.remove('open');
});
els.mapImagePanel.addEventListener('click', (e) => {
  if (e.target === els.mapImagePanel) els.mapImagePanel.classList.remove('open');
});
